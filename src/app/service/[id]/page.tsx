...
import { ContactMethod } from "@/types/service";
 ...
 * - Service title, description, and images
...
export default async function ServicePage({
  ...
  params: Promise<{ id: string }>; // Marked as Promise since Next.js passes async params
}) {
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col md:flex-row justify-between gap-5">
              ...
              <div className="flex gap-2 items-center">
                <Image
                  src={service.author?.image || "/defaul-avatar.png"}
                  alt="avatar"
                  width={64}
                  height={64}
                ...
                />
                <div>
                  <p className="text-20-medium">{service.author?.name || "Unknown Provider"}</p>
                  <p className="text-14-normal text-gray-500">Service Provider</p>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 space-y-3">
              ...
              {service.priceRange && (
                <p className="flex items-center gap-2">
                  ...
                  <span className="font-medium">Price:</span> {getPriceDisplay(service.priceRange)}
                </p>
              )}
              ...
              {service.contactMethod && (
                <p className="flex items-center gap-2">
                  ...
                  <span className="font-medium">Contact via:</span> {service.contactMethod}
                </p>
              )}
              ...
              {service.serviceRadius && (
                <p className="flex items-center gap-2">
                  ...
                  <span className="font-medium">Service area:</span> {service.serviceRadius}km radius
                </p>
              )}
